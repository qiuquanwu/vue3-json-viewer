...
var script$9 = {
    ...
    mounted: function mounted() {
        ...
        if (this.copyable) {
            var clipBoard = new Clipboard__default['default'](this.$refs.clip, {
                text: function text() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock('div', { 'class': $options.jvClass }, [
        $props.copyable ? (vue.openBlock(), vue.createBlock('div', {
            key: 0,
        ...
        $data.expandableCode && $props.boxed ? (vue.openBlock(), vue.createBlock('div', {
            key: 1,
            'class': 'jv-more',
